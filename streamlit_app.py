...
for i, dia in enumerate(itinerario):
    ...
    hoteles_disponibles = df_hoteles[
        ...
        (
            ...
            (df_hoteles["Tipo de día"].str.lower() == "precio unico")
        ))
    ]
    ...
    if hotel_seleccionado:
        ...
        fila_hotel = hoteles_disponibles[hoteles_disponibles["Hotel"] == hotel_nombre]
        if not fila_hotel.empty:
            precio_hotel = int(fila_hotel.iloc[0]["Total por noche con impuesto (JPY)"])
